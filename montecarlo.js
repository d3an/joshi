...
function integrateWasmJS() {
  ...
  var wasmTextFile = 'montecarlo.wast';
  var wasmBinaryFile = 'montecarlo.wasm';
  var asmjsCodeFile = 'montecarlo.temp.asm.js';
...
var real__calculateCallPayoff = asm["_calculateCallPayoff"]; asm["_calculateCallPayoff"] = function() {
  assert(runtimeInitialized, 'you need to wait for the runtime to be ready (e.g. wait for main() to be called)');
  assert(!runtimeExited, 'the runtime was exited (use NO_EXIT_RUNTIME to keep it alive after main() exits)');
  return real__calculateCallPayoff.apply(null, arguments);
};

var real__calculatePutPayoff = asm["_calculatePutPayoff"]; asm["_calculatePutPayoff"] = function() {
  assert(runtimeInitialized, 'you need to wait for the runtime to be ready (e.g. wait for main() to be called)');
  assert(!runtimeExited, 'the runtime was exited (use NO_EXIT_RUNTIME to keep it alive after main() exits)');
  return real__calculatePutPayoff.apply(null, arguments);
};
...
var _calculateCallPayoff = Module["_calculateCallPayoff"] = function() {
  assert(runtimeInitialized, 'you need to wait for the runtime to be ready (e.g. wait for main() to be called)');
  assert(!runtimeExited, 'the runtime was exited (use NO_EXIT_RUNTIME to keep it alive after main() exits)');
  return Module["asm"]["_calculateCallPayoff"].apply(null, arguments) };
var _calculatePutPayoff = Module["_calculatePutPayoff"] = function() {
  assert(runtimeInitialized, 'you need to wait for the runtime to be ready (e.g. wait for main() to be called)');
  assert(!runtimeExited, 'the runtime was exited (use NO_EXIT_RUNTIME to keep it alive after main() exits)');
  return Module["asm"]["_calculatePutPayoff"].apply(null, arguments) };
